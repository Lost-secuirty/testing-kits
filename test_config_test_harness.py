...
from config_test_harness import (
    FieldSchema,
    ConfigSchema,
    ConfigValidator,
    EnvOverrideChecker,
...
class TestMockConfigServer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from config_test_harness import MockConfigHandler
...
class TestIntegration(unittest.TestCase):
    ...
    def test_env_override_then_validate(self):
        ...
        self.assertTrue(report.is_valid)
        found, val = __import__("config_test_harness")._get_nested(overridden, "db.host")

...
- Path: `harnesses/core/stress_test_harness.py`
- Category: `core`
...
- Commands: `python tools/teeth_check.py harnesses/core/stress_test_harness.py`; `python harnesses/core/stress_test_harness.py --self-test`; `python harnesses/core/stress_test_harness.py --json`; `python -m unittest tests.core.test_stress_test_harness tests.core.test_stress_proof`; `make test-core`; `make proof` for current global proof state.
